...
export const uk: EnDict = {
  ...
  "unapproved.banner.body":
    "Вашу пошту підтверджено, але адмін ще не схвалив акаунт. До схвалення денний ліміт — 5 відео, 5 GIF та 10 скріншотів.",
  "unapproved.popup.title": "Сьогоднішній ліміт вичерпано",
  "unapproved.popup.body.video":
    "Несхвалені акаунти можуть завантажувати 5 відео на добу. Щоб завантажити ще, дочекайтеся схвалення адміна.",
  "unapproved.popup.body.gif":
    "Несхвалені акаунти можуть завантажувати 5 GIF на добу. Щоб завантажити ще, дочекайтеся схвалення адміна.",
